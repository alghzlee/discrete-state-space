...
class EWD3QN_Net(nn.Module):
    def __init__(self, state_dim, n_actions):
        super(EWD3QN_Net, self).__init__()
...
class EWD3QN:
    def __init__(self, state_dim=37, num_actions=25, ensemble_size=5, gamma=0.99, tau=0.4):
        ...
        # Ensemble Q-Networks
        self.Q_ensemble = [EWD3QN_Net(state_dim, num_actions).to(
        ...
        self.optimizers = [torch.optim.AdamW(
            q_net.parameters(), lr=0.00003) for q_net in self.Q_ensemble]
